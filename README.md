# Pahra – Цифровая платформа для ежегодного мероприятия «Трип Пахра». 
На текущем этапе — модуль регистрации участников; в планах расширение функционала (личные кабинеты, регистрация на события, медиа-блоки, панель администрирования).(In development)
